...
// 使用更柔和的深灰色背景 (Slate 800/900)
const defaultAppBgColor: RgbaColor = {
  r: 30,
  g: 41,
  b: 59,  // #1e293b (Slate 800)
  a: 1,
}
...
// 使用更柔和的文本颜色，提高可读性
const defaultDarkLeftPanelTextColor: string = '#e5e7eb'  // Gray 200
const defaultLightLeftPanelTextColor: string = '#1f2937' // Gray 800
